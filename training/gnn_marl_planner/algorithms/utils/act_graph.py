from .distributions_graph import Bernoulli, Categorical, DiagGaussian
import torch
...
class ACTLayer(nn.Module):
    ...
    def __init__(self, action_space, inputs_dim, use_orthogonal, gain, args=None):
        ...
        print("action_space.__class__.__name__ is", action_space.__class__.__name__)
    ...
    def forward(self, x, available_actions=None, deterministic=False, distance = None):
        """
        ...
        if self.mixed_action :
            ...
            for action_out in self.action_outs:
                ...
                print("deterministic is", deterministic)
            ...
            # action_logits.mode() 其实是返回一个
            # print("action logits is", soft_prob)
            actions = action_logits.mode() if deterministic else action_logits.sample() 
            action_log_probs = action_logits.log_probs(actions)
        return actions, action_log_probs
        # return actions, action_log_probs, soft_prob
