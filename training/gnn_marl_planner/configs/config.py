...
def get_config():
    ...
    parser.add_argument("--gnn_hidden_size", type=int, default=48, help="Dimension of hidden layers gnn attention of a single head")   
    parser.add_argument("--gnn_num_heads", type=int, default=4, help="Number of heads in the multiheadattention models")
    parser.add_argument("--gnn_concat_heads", action='store_false', default=True, help="Whether to concat heads in the multiheadattention models")
    parser.add_argument("--num_embeddings", type=int, default=5, help="Number of embeddings")
    parser.add_argument("--embedding_size", type=int, default=64, help="Dimension of embeddings")
    parser.add_argument("--gnn_layer_N", type=int, default=2, help="Number of TransformerConv in the network")
    parser.add_argument("--gnn_use_ReLU", action='store_false', default=True, help="Whether to use ReLU in the network")
    parser.add_argument("--global_aggr_type", type=str, default='mean', choices=["mean", "max", "add"], help="Type of global aggregation for critic network")
    parser.add_argument("--embed_hidden_size", type=int, default=128, help="Dimension of hidden layers in embeded conv in aggregating the features of nodes")
    parser.add_argument("--embed_layer_N", type=int, default=2, help="Number of hidden layers in embeded conv in aggregating the features of nodes")
    parser.add_argument("--embed_use_ReLU", action='store_false', default=True, help="Whether to use ReLU in embeded conv in aggregating the features of nodes. If false, then using Tanh.")
    parser.add_argument("--user_feature_normalization", action='store_false', default=True, help="Whether to apply layernorm in embeded conv:\
                        layer_norm = [nn.Identity(), nn.LayerNorm(hidden_size)][use_layerNorm]")
    parser.add_argument("--embed_add_self_loop", action='store_true', default=False, help="Whether to add self loop in embeded conv in aggregating the features of nodes")
    ...
    parser.add_argument("--nn_type", type=str,
                        default='mlp', choices=["mlp", "cnn", "mixer", 'resnet18', 'attention', 'attention_modified','attention_dense',
                                                'attention_batchnorm', 'attention_batchnorm_dense', 'attention_batchnorm_modified', 'attention_resnet','attention_resnet_120', 'attention_resnet_obs_distance', 'attention_resnet_obs_joint_obs_distance',
                                                "gnn"])
    ...
    parser.add_argument("--hidden_size", type=int, 
                        default=192, help="Dimension of hidden layers for actor/critic networks")
    ...
    parser.add_argument("--transpose_time", type=int, default=1, help='The time of transpose applied in model')
